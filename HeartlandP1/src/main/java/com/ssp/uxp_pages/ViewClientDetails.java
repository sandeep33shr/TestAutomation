...
public class ViewClientDetails extends LoadableComponent<HomePage> {
	...
	protected void isLoaded() {
		...
		if (!driver.getTitle().contains("Corporate Client Details")) {
			Log.fail("View Client Details Page did not open up. Site might be down.", driver, extentedReport);
		} else {
			Log.message("Successfully navigated to View Client Details Page", driver, extentedReport);
		}
	}
