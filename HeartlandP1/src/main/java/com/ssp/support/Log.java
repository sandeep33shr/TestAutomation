...
public class Log extends BaseTest {
	...
	static {
		...
		if (params.containsKey("printconsoleoutput")) {
			Boolean.parseBoolean(params.get("printconsoleoutput"));
		}
	 ...
	 * End test case.
	 *
	 * @param extentReporterTests the extent reporter tests
	 */
	 ...
	 * @param description the description
	 * @param driver the driver
	 * @param takeScreenShot the take screen shot
	 */
	...
	/**
	 * Assert that extent report.
	 *
	 * @param status the status
	 * @param passmsg the passmsg
	 * @param failmsg the failmsg
	 * @param driver the driver
	 */
