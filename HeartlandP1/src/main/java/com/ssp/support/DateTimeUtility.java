...
public class DateTimeUtility {
	...
	/** The sample date format 1. */
	static String sampleDateFormat1 = "yyyy-MM-dd";
	
	/** The sample date format 2. */
	 ...
	 * @throws ParseException             - java data parse exception
	 */
	 ...
	 * parameters.
	 *
	 * @param preferredDay the preferred day
