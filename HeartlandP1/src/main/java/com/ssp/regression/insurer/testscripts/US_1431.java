...
public class US_1431 extends BaseTest {
	...
	@Test(description = "To Validate that SRP is posted to client and bank account through Collection Details process", dataProviderClass = DataProviderUtils.class, dependsOnMethods = "TC_1431_6850_03", dataProvider = "ssBVTDataProvider", alwaysRun = true)
	...
	@Test(description = "To Validate that Produce document che checkbox default logic based on media type selection", dataProviderClass = DataProviderUtils.class, dataProvider = "ssBVTDataProvider", dependsOnMethods = "TC_1431_6857")
